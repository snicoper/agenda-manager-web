...
A ver si con esto me puedes ayudar, es Angular:
...
Tengo esa clase que me permite mostrar mensajes en consola, pero solo los muestra en producción, no en desarrollo.

Pero me gustaría pasar un numero indeterminado de parametros y que me muestre todos los mensajes en consola como `console.log('mensaje1', 'mensaje2', 'mensaje3')`

Que ademas, los parámetros pudan ser de cualquier tipo, no solo strings.

```ts
logInfo('mensaje1', 'mensaje2', 'mensaje3');
```
